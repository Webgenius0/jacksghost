...
export default function Create({ leagues }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('league-content.store'), {
            onSuccess: () => {
                reset();
            },
            onError: () => {
                toast.error('Failed to create League Content.');
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Create League Content', href: '/league-content/create' }
        ]}>
            <Head title="Create League Content" />
                        ...
                        <CardContent>
                            <div className="grid gap-4">
                                <div className="flex flex-col space-y-1.5">
                                    <Label htmlFor="league_id">League <span className="text-red-500">*</span></Label>
                                    <select
                                        id="league_id"
                                ...
                                <div className="flex flex-col space-y-1.5">
                                    <Label htmlFor="agent_content">Agent Content</Label>
